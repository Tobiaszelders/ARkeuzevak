...
if "%ANDROIDHOME%"=="" set ANDROIDHOME=C:\Users\tobiz\AppData\Local\Android\Sdk
...
@echo Installing new data. Failures here indicate storage problems (missing SD card or bad permissions) and are fatal.
	%AFS% %DEVICE% -p com.YourCompany.MyProject -k 25DA8B444FCAB53B943873B8451C0382 push main.1.com.YourCompany.MyProject.obb "^mainobb"
if "%ERRORLEVEL%" NEQ "0" goto Error
...
%AFS% %DEVICE% -p com.YourCompany.MyProject -k 25DA8B444FCAB53B943873B8451C0382 stop-all
...
%ADB% %DEVICE% shell pm grant com.YourCompany.MyProject android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant com.YourCompany.MyProject android.permission.WRITE_EXTERNAL_STORAGE
